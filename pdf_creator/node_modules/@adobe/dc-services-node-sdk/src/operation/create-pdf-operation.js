...
const CreatePDFApi = require('../internal/api/create-pdf-api'),
...
const SupportedMediaTypes = {
	...
	allowedConfiguration = {
		...
		/**
         * Represents media types that can only be provided through urls
         */
 ...
 * <p>
 * The supported source media types are listed here. The {@link SupportedMediaTypes} object can be used to map file
 ...
 *        input = DCServicesSdk.FileRef.createFromLocalFile('test/resources/createPDFInput.docx');
 *
...
class CreatePDFOperation {
     ...
     * in {@link module:DCServicesSDK#CreatePDF}.
     */
	setOptions(options) {
	...
	execute(context) {
		...
		return CreatePDFApi.convertToPdf(context, this.sourceFileRef, targetFileName,this.options)
