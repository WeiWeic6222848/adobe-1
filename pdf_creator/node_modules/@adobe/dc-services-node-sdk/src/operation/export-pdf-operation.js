...
const ExportPDFApi = require('../internal/api/export-pdf-api'),
 ...
 *        input = DCServicesSdk.FileRef.createFromLocalFile('test/resources/PDF.pdf');
 *
...
class ExportPDFOperation {
	...
	execute(context) {
		...
		const targetFileName = getRandomFileNameWithExtension(allowedConfiguration
			.getTargetFileExtension(this.targetFormat));
		logger.info('All validations successfully done. Beginning PDF export');
		return ExportPDFApi.exportPDF(context, this.sourceFileRef,this.targetFormat, targetFileName)
